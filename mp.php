      ...
      <div class="row justify-content-center py-5">
        <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
          <h1 class="display-3 text-white mb-3 animated slideInDown" style="font-size: 5rem;">
            <span style="background-color: rgba(127, 127, 127, 0.5); padding: 10px; border-radius: 10px;">MADHYA PRADESH</span>
          </h1>
        </div>
      </div>
    </div>
...
<div class="container mt-5">
  <h2 class="text-center mb-4">Explore Madhya Pradesh Destinations</h2>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img6\bhopal.jpeg" class="card-img-top" alt="Kochi" >
              <div class="card-body">
              <h5 class="card-title">Bhopal</h5>
                <p class="card-text">Upper Lake, Bhimbetka Caves, Birla Museum</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img6\indore.jpg" class="card-img-top" alt="Alappuzha" >
              <div class="card-body">
              <h5 class="card-title">Indore</h5>
                <p class="card-text">Rajwada Palace, Lal Bagh Palace, Sarafa Bazaar</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img6\gwalior.jpeg" class="card-img-top" alt="Munnar" >
              <div class="card-body">
              <h5 class="card-title">Gwalior</h5>
                <p class="card-text">Gwalior Fort, Jai Vilas Palace, Sun Temple</p>
      ...
      <div class="carousel-item">
        <div class="row">
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img6\ujjain.jpg" class="card-img-top" alt="Kovalam Beach" >
              <div class="card-body">
              <h5 class="card-title">Ujjain </h5>
                <p class="card-text">Mahakaleshwar Temple, Kal Bhairav Temple, Ram Ghat</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img6\jabalpur.jpg" class="card-img-top" alt="Lighthouse Beach" >
              <div class="card-body">
              <h5 class="card-title">Jabalpur</h5>
                <p class="card-text">Dhuandhar Falls, Marble Rocks, Madan Mahal Fort<br><br></p>
