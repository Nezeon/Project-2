        ...
        <div class="row justify-content-center py-5">   
            <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown" style="font-size: 5rem;">
                    <span style="background-color: rgba(127, 127, 127, 0.5); padding: 10px; border-radius: 10px;">NAINITAL</span>
                ...
                <p class="text-white" style="font-size: 1.25rem;">Budget starting from Rs.18,000 </p>
            </div>
        </div>
    </div>
</div>
...
<div class="container mt-5">
  <h2 class="text-center mb-4">Explore Nainital Destinations</h2>
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="img2\nainital-naini-lake.webp" class="card-img-top" alt="Kohima">
                        <div class="card-body">
                            <h5 class="card-title">Naini Lake</h5>
                            <p class="card-text">A picturesque lake surrounded by hills, offering boating and stunning views of the surrounding landscapes.</p>
                            <p class="card-text">Nearest Police Station: Nainital Police Station (Distance: 2 km)</p>
                            <p class="card-text">Nearest Hospital: Naini Hospital (Distance: 3 km)</p>
                            <a href="kochi.html" class="btn btn-primary">See More</a>
                        </div>
                    </div>
                </div>
                <!-- Naina Devi Temple< Slide -->
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="img2\naina-devi-temple.jpg" class="card-img-top" alt="Dimapur">
                        <div class="card-body">
                            <h5 class="card-title">Naina Devi Temple</h5>
                            <p class="card-text">A sacred temple dedicated to Goddess Naina Devi, located on the banks of Naini Lake.</p>
                            <p class="card-text">Nearest Police Station: Nainital Police Station (Distance: 1.5 km)</p>
                            <p class="card-text">Nearest Hospital: Naini Hospital (Distance: 2.5 km)</p>
                            <a href="alappuzha.html" class="btn btn-primary">See More</a>
                        </div>
                    </div>
                </div>
                <!-- Tiffin Top (Dorothy's Seat) Slide -->
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="img2\tiffin-top.webp" class="card-img-top" alt="Mokokchung">
                        <div class="card-body">
                            <h5 class="card-title">Tiffin Top (Dorothy's Seat)</h5>
                            <p class="card-text">A popular viewpoint offering panoramic views of Nainital town and the Himalayas, accessible via a short trek.</p>
                            <p class="card-text">Nearest Police Station: Nainital Police Station (Distance: 3.5 km)</p>
                            <p class="card-text">Nearest Hospital: Naini Hospital (Distance: 4 km)</p>
        ...
        <div class="carousel-item">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="img2\eco-cave-park.jpg" class="card-img-top" alt="Wokha">
                        <div class="card-body">
                            <h5 class="card-title">Eco Cave Park</h5>
                            <p class="card-text">Garden park with shade trees, multiple caves for exploring & a mechanical bull ride.</p>
                            <p class="card-text">Nearest Police Station: Mallital Police Station (Distance: 2.5 km)</p>
                            <p class="card-text">Nearest Hospital: Brijlal Hospital (Distance: 3.5 km)</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="img2\jim-corbett.jpg" class="card-img-top" alt="Tuensang">
                        <div class="card-body">
                            <h5 class="card-title">Jim Corbett National Park</h5>
                            <p class="card-text">Jim Corbett National Park is a forested wildlife sanctuary in northern India’s Uttarakhand State.</p>
                            <p class="card-text">Nearest Police Station: Ramnagar Police Station (Distance: 5 km)</p>
                            <p class="card-text">Nearest Hospital: Government Hospital Ramnagar (Distance: 6.5 km)</p>
