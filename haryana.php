      ...
      <div class="row justify-content-center py-5">
        <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
          <h1 class="display-3 text-white mb-3 animated slideInDown" style="font-size: 5rem;">
            <span style="background-color: rgba(127, 127, 127, 0.5); padding: 10px; border-radius: 10px;">HARYANA</span>
          </h1>
        </div>
      </div>
    </div>
...
<div class="container mt-5">
  <h2 class="text-center mb-4">Explore Haryana Destinations</h2>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img5\faridabad.jpg" class="card-img-top" alt="Kochi" >
              <div class="card-body">
              <h5 class="card-title">Faridabad</h5>
                <p class="card-text">Surajkund, Raja Nahar Singh Palace, Badkhal Lake</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img5\gurugram.jpg" class="card-img-top" alt="Alappuzha" >
              <div class="card-body">
              <h5 class="card-title">Gurugram</h5>
                <p class="card-text">Kingdom of Dreams, Cyber Hub, Sultanpur Bird Sanctuary</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img5\karnal.jpg" class="card-img-top" alt="Munnar" >
              <div class="card-body">
              <h5 class="card-title">Karnal</h5>
                <p class="card-text">Karnal Fort, Kalpana Chawla Planetarium, Cantonment Church Tower</p>
      ...
      <div class="carousel-item">
        <div class="row">
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img5\hisar-fort.jpg" class="card-img-top" alt="Kovalam Beach" >
              <div class="card-body">
              <h5 class="card-title">Hisar Fort</h5>
                <p class="card-text">Ancient fort with architectural significance, houses several monuments and temples.</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img5\blue-bird-lake.jpg" class="card-img-top" alt="Lighthouse Beach" >
              <div class="card-body">
              <h5 class="card-title">Blue Bird Lake</h5>
                <p class="card-text">Scenic lake with boating facilities, surrounded by lush greenery and walking trails.</p>
