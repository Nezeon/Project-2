      ...
      <div class="row justify-content-center py-5">
        <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
          <h1 class="display-3 text-white mb-3 animated slideInDown" style="font-size: 5rem;">
            <span style="background-color: rgba(127, 127, 127, 0.5); padding: 10px; border-radius: 10px;">JHARKHAND</span>
          </h1>
        </div>
      </div>
    </div>
...
<div class="container mt-5">
  <h2 class="text-center mb-4">Explore Jharkhand Destinations</h2>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img3/ranchi.jpg" class="card-img-top" alt="Kochi" >
              <div class="card-body">
              <h5 class="card-title">Ranchi</h5>
                <p class="card-text">Rock Garden, Pahari Mandir, Tagore Hill<br><br></p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img3\jamshedpur.jpeg" class="card-img-top" alt="Alappuzha" >
              <div class="card-body">
              <h5 class="card-title">Jamshedpur</h5>
                <p class="card-text">Jubilee Park, Tata Steel Zoological Park, Dimna Lake</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img3/dhanbad.jpg" class="card-img-top" alt="Munnar" >
              <div class="card-body">
              <h5 class="card-title">Dhanbad</h5>
                <p class="card-text">Maithon Dam, Bhatinda Falls, Panchet Dam</p>
      ...
      <div class="carousel-item">
        <div class="row">
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img3/deoghar.jpg" class="card-img-top" alt="Kovalam Beach" >
              <div class="card-body">
              <h5 class="card-title">Deoghar</h5>
                <p class="card-text">Baba Baidyanath Temple, Nandan Pahar, Tapovan Caves</p>
                <a href="kovalam.html" class="btn btn-primary">See More</a>
              </div>
            </div>
          </div>
          <!-- Lighthouse Beach Card -->
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img3\hazaribagh.jpeg" class="card-img-top" alt="Lighthouse Beach" >
              <div class="card-body">
              <h5 class="card-title">Hazaribagh</h5>
                <p class="card-text">Hazaribagh National Park, Canary Hill, Rajrappa Temple</p>
