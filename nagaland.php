      ...
      <div class="row justify-content-center py-5">
        <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
          <h1 class="display-3 text-white mb-3 animated slideInDown" style="font-size: 5rem;">
            <span style="background-color: rgba(127, 127, 127, 0.5); padding: 10px; border-radius: 10px;">NAGALAND</span>
          </h1>
        </div>
      </div>
    </div>
...
<div class="container mt-5">
  <h2 class="text-center mb-4">Explore Nagaland Destinations</h2>
      ...
      <div class="carousel-item active">
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img8/kohima-war-cemetery.jpg" class="card-img-top" alt="Kohima" >
                <h5 class="card-title">Kohima</h5>
                <p class="card-text">Kohima War Cemetery, Naga Heritage Village, Dzükou Valley</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img8/dimapur.jpg" class="card-img-top" alt="Dimapur" >
                <h5 class="card-title">Dimapur</h5>
                <p class="card-text">Kachari Ruins, Nagaland Science Centre, Diezephe Craft Village</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img8/mokokchung.jpeg" class="card-img-top" alt="Mokokchung" >
                <h5 class="card-title">Mokokchung</h5>
                <p class="card-text">Longkhum, Ungma Village, Mokokchung Village<br><br></p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img8/wokha.jpg" class="card-img-top" alt="Wokha" >
                <h5 class="card-title">Wokha</h5>
                <p class="card-text">Doyang River, Mount Tiyi, Wokha Town</p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="img8/tuensang.jpg" class="card-img-top" alt="Tuensang" o>
                <h5 class="card-title">Tuensang</h5>
                <p class="card-text">Changsangmongko Village, Tsadang Village, Longtro</p>
